...
async function lookupEvaluation(owner, repo, path) {
  ...
  // (e.g. ``github.com/owner/repo``) so normalising here avoids 404s.
...
function patchHistoryNavigation() {
  if (window.__skillAuditGithubHistoryPatched) return;
  window.__skillAuditGithubHistoryPatched = true;
